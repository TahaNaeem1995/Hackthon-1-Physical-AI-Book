...
(module.exports = {
  ...
  projectName: 'ai-physical-ai-book', // Usually your repo name.
  trailingSlash: false,
  customFields: {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'AI-Native Physical AI Book',
        logo: {
        ...
        items: [
          ...
          {to: '/docs/module-1/module-1', label: 'Module 1', position: 'left'},
          {
            href: 'https://github.com/your-username/ai-physical-ai-book',
            label: 'GitHub',
            position: 'right',
          },
        ],
